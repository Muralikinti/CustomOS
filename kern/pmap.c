...
{
	size_t num_pages = size / PGSIZE;  // Calculate the number of pages to map
...
mmio_map_region(physaddr_t pa, size_t size)
{
	...
	if (base > MMIOLIM) panic("not enough memory");
...
user_mem_check(struct Env *env, const void *va, size_t len, int perm)
{
    ...
    while (start < end) {
        ...
        if (!pte || !(*pte & PTE_P) || (*pte & perm) != perm || start >= ULIM) {
